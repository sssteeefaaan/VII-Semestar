...
{
	if (nChar == VK_RIGHT)
		m_glRenderer.RotateScene(0, -1);
	else if (nChar == VK_LEFT)
		m_glRenderer.RotateScene(0, 1);
	else if (nChar == VK_UP)
		m_glRenderer.RotateScene(1, 0);
	else if (nChar == VK_DOWN)
		m_glRenderer.RotateScene(-1, 0);
	else if (nChar == 'V')
		m_glRenderer.dVizor += 0.2;
	else if (nChar == 'C')
		m_glRenderer.dVizor -= 0.2;
	else if (nChar == 'D')
		m_glRenderer.dHidden += 0.2;
	else if (nChar == 'S')
		m_glRenderer.dHidden -= 0.2;
	else if (nChar == 'E')
		m_glRenderer.dHolder += 0.2;
	else if (nChar == 'W')
		m_glRenderer.dHolder -= 0.2;
	else if (nChar == 'G')
		m_glRenderer.angleHor += 1;
	else if (nChar == 'F')
		m_glRenderer.angleVer += 1;
	else if (nChar == 'A')
		m_glRenderer.alpha += 1;
	Invalidate();
