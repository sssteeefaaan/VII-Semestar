...
public:
	...
	void DrawKaktus3(CDC* pDC, CRect& rect, float angle, int krug);		

	void DrawLeviKrak(CDC* pDC, CRect& rect);		
	void DrawDesniKrak(CDC* pDC, CRect& rect);		
	...
	void Refleksija(CDC* pDC, bool rightMultiply);
